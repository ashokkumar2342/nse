...
<body>
    <form action="{{ url('mango-store') }}" method="get" accept-charset="utf-8">
...
<div class="row"> 
	...
	<div class="col-lg-3">
		<label>pinkod</label>
		<input type="text" name="pinkod" class="form-control" required="" >
	</div>
</div>
<div class="row">
<div class="col-lg-2">
    ...
    <div class="col-lg-2">
        <label>cuntry</label>
        <input type="text" name="cuntry" class="form-control"  required="">
    </div>
    <div class="col-lg-6">
         <label>student</label>
