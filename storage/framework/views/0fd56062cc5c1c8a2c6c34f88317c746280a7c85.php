...
<head>
  ...
  <link href=<?php echo asset('admin_asset/dist/css/bootstrap-multiselect.css'); ?> rel="stylesheet" type="text/css">
...
<body class="hold-transition skin-red sidebar-mini" id="body_id">
    ...
    <script src=<?php echo asset('admin_asset/dist/js/bootstrap-multiselect.js'); ?>> 
    </script>
