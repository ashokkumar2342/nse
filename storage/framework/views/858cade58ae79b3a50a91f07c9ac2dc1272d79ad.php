...
<section class="content-header">
    ...
    <section class="content">
        <div class="box">             
            ...
            <form action="<?php echo e(route('ayushstore')); ?>" search-url="<?php echo e(route('ayushstore')); ?>" id="form-overview"    method="post" accept-charset="utf-8">  
         ...
         $('#form-overview').on('submit', function(event) {  
           event.preventDefault();
             setInterval(function(){
                 $.getJSON('<?php echo e(route('progressbar')); ?>', function(data) {
