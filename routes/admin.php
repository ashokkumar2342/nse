	...
	Route::group(['prefix' => 'finance'], function() {
		...
		Route::group(['prefix' => 'exam'], function() {	
			...
			Route::group(['prefix' => 'mobile'], function() {
			    ...
			    Route::get('car', 'MobileController@car')->name('car');	
			    Route::get('carstore', 'MobileController@carstore')->name('carstore');	 	
			     	
			    Route::get('laptop', 'MobileController@laptop')->name('laptop');	 	
			    Route::get('laptopstore', 'MobileController@laptopstore')->name('laptopstore');	 	
			    Route::get('bike', 'MobileController@bikestore')->name('bikestore');	 	
			    Route::get('bikestore', 'MobileController@bike')->name('bike');	 	
			    Route::get('redio', 'MobileController@redio')->name('redio');	 	
			    Route::get('rediostore', 'MobileController@rediostore')->name('rediostore');	 	
			    Route::get('mobilestore', 'MobileController@mobilestore')->name('mobilestore');	 	
			    Route::get('telibijen', 'MobileController@telibijen')->name('telibijen');	 	
			    Route::get('telibijenstore', 'MobileController@telibijenstore')->name('telibijenstore');	 	
			    Route::get('user', 'MobileController@user')->name('user');	 	
			    Route::get('userstore', 'MobileController@userstore')->name('userstore');	 	
			    Route::get('ayush', 'MobileController@ayush')->name('ayush');	 	
			    Route::post('ayushstore', 'MobileController@ayushstore')->name('ayushstore');	 	
			    Route::get('progressbar', 'MobileController@progressbar')->name('progressbar');	 	
